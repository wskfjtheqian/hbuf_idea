...
public class HbufIdentNameImpl extends HbufNameElementImpl implements HbufIdentName {

  public HbufIdentNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HbufVisitor visitor) {
    visitor.visitIdentName(this);
  }
