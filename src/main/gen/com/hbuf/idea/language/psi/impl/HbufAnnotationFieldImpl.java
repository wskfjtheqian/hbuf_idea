...
public class HbufAnnotationFieldImpl extends HbufAnnotationFieldElementImpl implements HbufAnnotationField {

  public HbufAnnotationFieldImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HbufVisitor visitor) {
    visitor.visitAnnotationField(this);
  }
  ...
  public HbufAnnotationValues getAnnotationValues() {
    return findNotNullChildByClass(HbufAnnotationValues.class);
  }
