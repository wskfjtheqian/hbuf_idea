...
public class HbufFuncStatementImpl extends HbufServerFuncElementImpl implements HbufFuncStatement {

  public HbufFuncStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public HbufFuncParam getFuncParam() {
    return findNotNullChildByClass(HbufFuncParam.class);
  }
