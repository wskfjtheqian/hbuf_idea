...
public class HbufServerBodyImpl extends HbufServerBodyElementImpl implements HbufServerBody {

  public HbufServerBodyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HbufVisitor visitor) {
    visitor.visitServerBody(this);
  }
